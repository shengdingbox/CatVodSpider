...
.method public constructor <init>(La/bc;)V
    ...
    iput-object p1, p0, Lorg/simpleframework/xml/stream/StreamReader;->reader:La/bc;
...
.method private attribute(La/Z;)Lorg/simpleframework/xml/stream/StreamReader$Entry;
    .locals 1
    ...
    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Entry;-><init>(La/Z;)V
...
.method private build(Lorg/simpleframework/xml/stream/StreamReader$Start;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    ...
    invoke-direct {p0, v1}, Lorg/simpleframework/xml/stream/StreamReader;->attribute(La/Z;)Lorg/simpleframework/xml/stream/StreamReader$Entry;
...
.method private read()Lorg/simpleframework/xml/stream/EventNode;
    ...
    :cond_1
    iget-object v0, p0, Lorg/simpleframework/xml/stream/StreamReader;->reader:La/bc;

    invoke-interface {v0}, La/bc;->a()La/ac;

    move-result-object v0

    invoke-interface {v0}, La/ac;->c()Z

    move-result v1

    if-nez v1, :cond_5

    invoke-interface {v0}, La/ac;->f()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-direct {p0, v0}, Lorg/simpleframework/xml/stream/StreamReader;->start(La/ac;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    ...
    :cond_2
    invoke-interface {v0}, La/ac;->d()Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-direct {p0, v0}, Lorg/simpleframework/xml/stream/StreamReader;->text(La/ac;)Lorg/simpleframework/xml/stream/StreamReader$Text;
...
.method private start(La/ac;)Lorg/simpleframework/xml/stream/StreamReader$Start;
    .locals 1
    const-wide v1, 0x400921fb54442d18L  # Math.PI
    invoke-static {v1, v1}, Ljava/lang/Math;->sin(D)D
    move-result-wide v1
    ...
    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Start;-><init>(La/ac;)V
...
.method private text(La/ac;)Lorg/simpleframework/xml/stream/StreamReader$Text;
    .locals 1
    const-wide v1, 0x400921fb54442d18L  # Math.PI
    invoke-static {v1, v1}, Ljava/lang/Math;->sin(D)D
    move-result-wide v1
    ...
    invoke-direct {v0, p1}, Lorg/simpleframework/xml/stream/StreamReader$Text;-><init>(La/ac;)V

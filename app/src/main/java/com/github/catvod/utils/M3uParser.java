...
public class M3uParser {
    public static Object[] S(String str) {
        try {
            ...
            b(linkedHashMap, str, null);
            return new Object[]{200, "text/plain; charset=utf-8", new ByteArrayInputStream(l8(linkedHashMap).getBytes("UTF-8"))};
        } catch (Throwable th) {
            th.printStackTrace();
            return null;
        }
    ...
    public static void T4(LinkedHashMap<String, LinkedHashMap<String, ArrayList<String>>> linkedHashMap, String str) {

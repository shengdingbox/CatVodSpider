...
public final class k {
    ...
    public static void A(String str, String str2, String str3, j jVar) {
        ...
        try {
            ...
            if (i.indexOf("验证码") >= 0) {
                ...
                builder.setPositiveButton((CharSequence) "确定", (DialogInterface.OnClickListener) new c(str2, jVar));
                bVar = new a(jVar);
            } else {
    ...
    public static Object y(Context context, String str, String str2) {
        ...
        Double.isNaN(height);
        webView2.setLayoutParams(new FrameLayout.LayoutParams(i2, (int) (height * 0.9d)));

...
public final  class RunnableC0091l implements Runnable {
    public final int a = 0;
    public final String b;
    public final Object c;
    public final Object d;

    public  RunnableC0091l(x xVar, String str, com.github.catvod.spider.merge.AB.d.d dVar) {
        this.c = xVar;
        this.b = str;
        this.d = dVar;
    }

    public  RunnableC0091l(String str, AtomicReference atomicReference, CountDownLatch countDownLatch) {
        this.b = str;
